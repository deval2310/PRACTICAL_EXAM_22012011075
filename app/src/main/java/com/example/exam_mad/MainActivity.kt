...
import com.example.exam_mad.ui.theme.EXAM_MADTheme
...
fun ReviewCard(name: String, review: String, rating: Int) {
    Card(
        ...
        Row(
            ...
            Image(
                painter = painterResource(id = R.drawable.user_image), // Replace with your image resource
            ...
            Column {
                ...
                Row {
                    repeat(rating) {
                        Icon(
                            painter = painterResource(id = R.drawable.baseline_star_rate_24), // Replace with star icon
